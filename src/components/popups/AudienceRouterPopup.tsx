    ...
    <div>
      ...
      */}
      <button
        type="button"
        onClick={onContinue}
        className="mt-6 text-xs font-semibold text-white/40 hover:text-white/80 transition-colors focus:outline-none rounded"
      >

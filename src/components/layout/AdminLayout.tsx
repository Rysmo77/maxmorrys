import {
  ...
  Mic, Video, CreditCard, Calendar, Star, Crown, Home, Briefcase, Boxes, Route,
} from 'lucide-react';
...
const ALL_NAV_ITEMS: AdminNavItem[] = [
  ...
  { to: '/admin/redirections',   labelKey: 'nav.redirects',    titleKey: 'nav.redirects',    icon: Route,           adminOnly: true },

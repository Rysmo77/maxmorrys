...
| `index.html`<br>Espace apprenant | *(rendu direct)* | `app-shell.jsx` `ScreensPublic.js` `ScreensPay.js` `ScreensPayEnd.js` `screens-space.jsx` `screens-rysmo.jsx` |
...
| `tableaux-de-bord.html`<br>Tableaux de bord desktop | `EspaceDesktop` · `ConsoleDesktop` | `dashboards.jsx` |

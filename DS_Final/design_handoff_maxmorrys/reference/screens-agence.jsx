  ...
  return (
    <Screen territory="digitalise" meshLobes={CORAIL}
      ...
      <GlassPanel level="hero" padding={22} className="rv" style={{'--i':6,marginTop:'20px'}}>
        ...
        <Field label="Type de projet" value="Plateforme web" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} />
        <Field label="Ta fourchette budgétaire" placeholder="Choisis une fourchette" state="focus" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} />

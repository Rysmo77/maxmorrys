...
function NatClubFil({os}){
  return (
    <NativeScreen os={os} territory="transforme" titre={os==='android'?'Le fil':null}
      ...
      {/* La bande des HUIT (NativeShell.js), pas les quatre valeurs du web : sinon cinq
          onglets sur huit n'étaient atteignables par aucun geste — la barre basse occupe
          déjà le bas de l'écran. */}
      <div style={{marginTop:'14px'}}><BandeClub actif="Fil" /></div>

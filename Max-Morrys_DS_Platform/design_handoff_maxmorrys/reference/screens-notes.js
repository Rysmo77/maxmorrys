  ...
  return (
    <Screen territory="forme"
      ...
      <GlassPanel level="flat" padding="6px 18px" className="rv" style={{'--i':5,marginTop:'14px'}}>
        <LessonRow state="plain" icon={<Icon name="comment" size={14} />} title="Lister ce que la cliente dit à voix haute, pas ce que je vends." meta="04/09 · 21:14 · Leçon 5" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} />
        <LessonRow state="plain" icon={<Icon name="comment" size={14} />} title="« cosmétique Almadies » plutôt que « cosmétique Sénégal »." meta="04/09 · 21:02 · Leçon 5" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} />
        <LessonRow state="plain" icon={<Icon name="comment" size={14} />} title="Vérifier les horaires de la fiche Google avant le week-end." meta="28/08 · 08:47 · Leçon 4" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} />
        <LessonRow state="plain" icon={<Icon name="comment" size={14} />} title="Garder les 20 mots qui reviennent, jeter le reste." meta="27/08 · 22:31 · Leçon 4" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} />
        <LessonRow state="plain" icon={<Icon name="comment" size={14} />} title="Photos de la boutique : refaire celles de la vitrine." meta="21/08 · 19:05 · Leçon 2" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} last />
      </GlassPanel>

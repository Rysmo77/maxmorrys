  ...
  return (
    <Screen territory="transforme"
      ...
      <GlassPanel level="flat" padding="4px 18px" className="rv" style={{'--i':8,marginTop:'10px'}}>
        <LessonRow icon={<Icon name="doc" size={14} />} title="Mes paiements" meta="1 transaction" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} />
        <LessonRow icon={<Icon name="star" size={14} />} title="Mes certificats" meta="0 émis" trailing={<Icon name="forward" size={16} color="#98A1AE" strokeWidth={2.4} />} onClick={()=>go('certificat')} last />
      </GlassPanel>
    </Screen>
  );
}

  ...
  return (
    <Screen territory="informe"
      ...
      <GlassPanel level="flat" padding="6px 18px" className="rv" style={{'--i':5,marginTop:'10px'}}>
        <LessonRow state="plain" icon={<Icon name="chat" size={14} color="#98A1AE" />} title={<span style={{color:'var(--text-faint)'}}>Ton {tutorNom().toLowerCase()}</span>} meta="a besoin du réseau" />
        <LessonRow state="plain" icon={<Icon name="card" size={14} color="#98A1AE" />} title={<span style={{color:'var(--text-faint)'}}>Paiement</span>} meta="a besoin du réseau" last />
      </GlassPanel>
    ...
    <Screen territory="transforme"
      ...
      <GlassPanel level="flat" padding="6px 18px" className="rv" style={{'--i':5,marginTop:'10px'}}>
        <LessonRow state="plain" icon={puce('users','#5A17BE')} iconBackground="rgba(108,35,221,.14)"
          title="Session en direct jeudi 20 h" meta="Club · hier" trailing={<Icon name="forward" size={15} color="#98A1AE" strokeWidth={2.4} />} />
        <LessonRow state="plain" icon={puce('users','#5A17BE')} iconBackground="rgba(108,35,221,.14)"
          title="Seynabou a répondu dans « Entraide »" meta="Club · mardi" trailing={<Icon name="forward" size={15} color="#98A1AE" strokeWidth={2.4} />} />
        <LessonRow state="plain" icon={puce('alert','#5A6472')} iconBackground="var(--fill-2)"
          title="Reprise de cours : 8 jours sans leçon" meta="Système · lundi" trailing={<Icon name="forward" size={15} color="#98A1AE" strokeWidth={2.4} />} />
        <LessonRow state="plain" icon={puce('card','#5A6472')} iconBackground="var(--fill-2)"
          title="Paiement Wave confirmé · 80 750 F" meta="Système · lundi" trailing={<Icon name="forward" size={15} color="#98A1AE" strokeWidth={2.4} />} last />
      </GlassPanel>
